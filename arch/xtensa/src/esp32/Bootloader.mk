...
$(BOOTLOADER_CONFIG): $(TOPDIR)/.config
	...
	$(Q) {                                                                                       \
		...
		[ "$(CONFIG_ESP32_SECURE_FLASH_ENCRYPTION_MODE_DEVELOPMENT)" = "y" ] && \
			echo "CONFIG_SECURE_FLASH_ENCRYPTION_MODE_DEVELOPMENT=y";  \
		...
		[ "$(CONFIG_ESP32_SECURE_FLASH_UART_BOOTLOADER_ALLOW_ENC)" = "y" ] && \
			echo "CONFIG_SECURE_FLASH_UART_BOOTLOADER_ALLOW_ENC=y";  \
		[ "$(CONFIG_ESP32_SECURE_FLASH_UART_BOOTLOADER_ALLOW_DEC)" = "y" ] && \
